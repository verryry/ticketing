										...
										<form method="POST" action="{{ url('transportation/create') }}">
											<div class="modal-body">
												...
												<div class="form-group{{ $errors->has('transportation_typeid') ? ' has-error' : '' }}">
													...
													<!--<input type="number" class="form-control" name="transportation_typeid" list="transportation_typeid"
													id="transportation_typeid" value="{{ old('transportation_typeid') }}" autofocus required>-->
													<select id="transportation_typeid" name="transportation_typeid" value="{{ old('transportation_typeid') }}" class="form-control">
														@foreach($transport_type as $transtype)
														<option value="{{ $transtype->id }}">{{$transtype->id}}</option>
														@endforeach
													</select>
